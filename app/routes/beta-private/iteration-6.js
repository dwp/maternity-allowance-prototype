...
router.post('/beta-private/iteration-6/scenario-1/start-a-claim/', function (req, res) {
  ...
  if (matchMoreInformationNeeded == true) {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/more-claimant-information');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/claim-date');
  }
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/more-claimant-information', function (req, res) {
  // Has a match been made, in this scenario?
  var match = true;

  if (match == false) {
    var match = null;
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/no-match-found');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/claim-date');
  }
...
router.post('/beta-private/iteration-6/scenario-1/start-a-claim/claim-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/about-the-baby');
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/about-the-baby', function (req, res) {
  if (req.session.data['baby-born'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/baby-birth-date');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/date-last-worked');
  }
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/baby-birth-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/date-last-worked');
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/date-last-worked', function (req, res) {
  if (req.session.data['stopped-work'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/dlw-date');
  }
  else {
...
// router.post('/beta-private/iteration-6/scenario-1/start-a-claim/ma-start-date-provided', function (req, res) {
//  if (req.session.data['ma-start-date-provided'] == 'yes') {
//    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/planned-dlw-date');
//  }
//  else {
//    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/chosen-map-date');
//  }
...
router.post('/beta-private/iteration-6/scenario-1/start-a-claim/planned-dlw-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/chosen-map-date');
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/chosen-map-date', function (req, res) {
  if (req.session.data['ma-date-requested'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/requested-start-date');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/summary');
  }
});

router.post('/beta-private/iteration-6/scenario-1/start-a-claim/requested-start-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-1/start-a-claim/summary');
});
...
router.post('/beta-private/iteration-6/scenario-3/start-a-claim/', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-3/start-a-claim/problem-with-service');
});
...
router.post('/beta-private/iteration-6/scenario-4/start-a-claim/', function (req, res) {
  ...
  if (matchMoreInformationNeeded == true) {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/more-claimant-information');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/claim-date');
  }
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/more-claimant-information', function (req, res) {
  // Has a match been made, in this scenario?
  var match = false;

  if (match == false) {
    var match = null;
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/no-match-found');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/claim-date');
  }
...
router.post('/beta-private/iteration-6/scenario-4/start-a-claim/claim-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/about-the-baby');
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/about-the-baby', function (req, res) {
  if (req.session.data['baby-born'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/baby-birth-date');
  }
  else {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/date-last-worked');
  }
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/baby-birth-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/date-last-worked');
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/date-last-worked', function (req, res) {
  if (req.session.data['stopped-work'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/dlw-date');
  }
  else {
    if (req.session.data['action'] == 'change') {
      req.session.data['action'] = null;
      res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/summary');
    }
    else {
      res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/chosen-map-date');
    }
  }
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/dlw-date', function (req, res) {
  if (req.session.data['action'] == 'change') {
    req.session.data['action'] = null;
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/summary');
  }
...
// Removed maternity leave question
// router.post('/beta-private/iteration-6/scenario-4/start-a-claim/ma-start-date-provided', function (req, res) {
//  if (req.session.data['ma-start-date-provided'] == 'yes') {
//    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/planned-dlw-date');
//  }
//  else {
//    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/chosen-map-date');
//  }
...
router.post('/beta-private/iteration-6/scenario-4/start-a-claim/planned-dlw-date', function (req, res) {
  res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/chosen-map-date');
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/chosen-map-date', function (req, res) {
  if (req.session.data['ma-date-requested'] == 'yes') {
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/requested-start-date');
  }
  else {
    //res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/summary');
    res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/problem-with-service');
  }
});

router.post('/beta-private/iteration-6/scenario-4/start-a-claim/requested-start-date', function (req, res) {
  //res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/summary');
  res.redirect('/beta-private/iteration-6/scenario-4/start-a-claim/problem-with-service');
});
...
router.post('/beta-private/', function (req, res) {
  res.redirect('/beta-private/iteration-6/find-a-claim/');
});

router.post('/beta-private/iteration-6/find-a-claim/', function (req, res) {
  res.redirect('/beta-private/iteration-6/find-a-claim/summary');
});
