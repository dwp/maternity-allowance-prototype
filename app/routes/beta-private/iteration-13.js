...
router.post('/beta-private/iteration-13/', function (req, res) {
...
router.post('/beta-private/iteration-13/start-a-claim/claim-date', function (req, res) {
  ...
  if (req.session.data['change'] == true ) {
    ...
    res.redirect('/beta-private/iteration-13/start-a-claim/summary/'); // Goes back to summary
  }
  else {
    // Regular journey
    req.session.data['change'] = null;
...
router.get('/beta-private/iteration-13/find-a-claim/summary/', function (req, res) {
  if (req.session.data['scenario'] == 'scenario-1') {
    res.redirect('/beta-private/iteration-13/find-a-claim/summary/1');
  } else if (req.session.data['scenario'] == 'scenario-2') {
    res.redirect('/beta-private/iteration-13/find-a-claim/summary/2');
  } else {
    res.redirect('/beta-private/iteration-13/find-a-claim/summary/3');
  }
});
