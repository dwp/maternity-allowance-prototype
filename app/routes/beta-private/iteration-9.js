...
router.post('/beta-private/iteration-9/scenario-1/start-a-claim/', function (req, res) {
  // clear data
  ...
  if (matchMoreInformationNeeded == true) {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/more-claimant-information');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/claim-date');
  }
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/more-claimant-information', function (req, res) {
  // Has a match been made, in this scenario?
  var match = true;

  if (match == false) {
    var match = null;
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/no-match-found');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/claim-date');
  }
...
router.post('/beta-private/iteration-9/scenario-1/start-a-claim/claim-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/about-the-baby');
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/about-the-baby', function (req, res) {
  if (req.session.data['baby-born'] == 'yes') {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/baby-birth-date');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/date-last-worked');
  }
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/baby-birth-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/date-last-worked');
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/date-last-worked', function (req, res) {
  if (req.session.data['stopped-work'] == 'yes') {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/dlw-date');
  }
  else {
    ...
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/chosen-map-date');
  }
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/dlw-date', function (req, res) {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/chosen-map-date');
});

// Removed maternity leave question
// router.post('/beta-private/iteration-9/scenario-1/start-a-claim/ma-start-date-provided', function (req, res) {
//  if (req.session.data['ma-start-date-provided'] == 'yes') {
//    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/planned-dlw-date');
//  }
//  else {
//    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/chosen-map-date');
//  }
...
router.post('/beta-private/iteration-9/scenario-1/start-a-claim/planned-dlw-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/chosen-map-date');
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/chosen-map-date', function (req, res) {
  if (req.session.data['ma-date-requested'] == 'yes') {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/requested-start-date');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/summary');
  }
});

router.post('/beta-private/iteration-9/scenario-1/start-a-claim/requested-start-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-1/start-a-claim/summary');
});
...
router.post('/beta-private/iteration-9/scenario-1/find-a-claim/', function (req, res) {
  // clear data
  req.session.data['baby-born'] = null;
  req.session.data['stopped-work'] = null;
  req.session.data['ma-date-requested'] = null;
  ...
  res.redirect('/beta-private/iteration-9/scenario-1/find-a-claim/summary');
});

router.post('/beta-private/iteration-9/scenario-1/find-a-claim/about-the-baby', function (req, res) {
    res.redirect('/beta-private/iteration-9/scenario-1/find-a-claim/baby-birth-date');
});

router.post('/beta-private/iteration-9/scenario-1/find-a-claim/baby-birth-date', function (req, res) {
    // Add changed session data here for alternative summary screen

    req.session.data['ma-baby-birth-date'] = '8 September 2022';

    res.redirect('/beta-private/iteration-9/scenario-1/find-a-claim/summary-change');
});

// *** Scenario 2 ***************************************************************************************************************** //

router.post('/beta-private/iteration-9/scenario-2/start-a-claim/', function (req, res) {
  // clear data
  req.session.data['baby-born'] = null;
  req.session.data['stopped-work'] = null;
  req.session.data['ma-date-requested'] = null;
  ...
  if (matchMoreInformationNeeded == true) {
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/more-claimant-information');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/claim-date');
  }
});

router.post('/beta-private/iteration-9/scenario-2/start-a-claim/more-claimant-information', function (req, res) {
  // Has a match been made, in this scenario?
  var match = true;

  if (match == false) {
    var match = null;
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/no-match-found');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/claim-date');
  }
...
router.post('/beta-private/iteration-9/scenario-2/start-a-claim/claim-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/about-the-baby');
});

router.post('/beta-private/iteration-9/scenario-2/start-a-claim/about-the-baby', function (req, res) {
  if (req.session.data['baby-born'] == 'yes') {
...
// Removed maternity leave question
// router.post('/beta-private/iteration-9/scenario-2/start-a-claim/ma-start-date-provided', function (req, res) {
//  if (req.session.data['ma-start-date-provided'] == 'yes') {
//    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/planned-dlw-date');
//  }
//  else {
//    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/chosen-map-date');
//  }
...
router.post('/beta-private/iteration-9/scenario-2/start-a-claim/planned-dlw-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/chosen-map-date');
});

router.post('/beta-private/iteration-9/scenario-2/start-a-claim/chosen-map-date', function (req, res) {
  if (req.session.data['ma-date-requested'] == 'yes') {
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/requested-start-date');
  }
  else {
    res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/summary');
  }
});

router.post('/beta-private/iteration-9/scenario-2/start-a-claim/requested-start-date', function (req, res) {
  res.redirect('/beta-private/iteration-9/scenario-2/start-a-claim/summary');
});

// **************** Scenario 3 - FIND A CLAIM (Change Requested Start Date) ****************** /

router.post('/beta-private/iteration-9/scenario-3/find-a-claim/', function (req, res) {
  // clear data
  req.session.data['baby-born'] = null;
  req.session.data['stopped-work'] = null;
  req.session.data['ma-date-requested'] = null;
  ...
  res.redirect('/beta-private/iteration-9/scenario-3/find-a-claim/summary');
});

router.post('/beta-private/iteration-9/scenario-3/find-a-claim/chosen-map-date', function (req, res) {
    res.redirect('/beta-private/iteration-9/scenario-3/find-a-claim/requested-start-date');
});
