...
module.exports = router => {
  ...
  router.post('/beta-private/iteration-16/', function (req, res) {
    ...
    res.redirect('/beta-private/iteration-16/landing');
  });
  
  // Payslip start claim
  router.post('/beta-private/iteration-16/start-a-claim/employers/add-employer', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/payslip/frequency');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/payslip/frequency', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/payslip/add');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/payslip/add', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/payslip/summary');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/payslip/summary', function (req, res) {
    if (req.session.data['ma-payslip-details-conf'] == 'yes') {
      res.redirect('/beta-private/iteration-16/start-a-claim/payslip/add');
    } else {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/1-three-employers');
    }
  });
  ...
  router.post('/beta-private/iteration-16/start-a-claim/', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/claimant-confirm');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/claimant-confirm', function (req, res) {
    
    if (req.session.data['claimant-confirm'] == 'yes') {
      res.redirect('/beta-private/iteration-16/start-a-claim/claim-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/more-claimant-information');
    }
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/more-claimant-information', function (req, res) {
    // Has a match been made, in this scenario?
    var match = true;
  
    if (match == false) {
      var match = null;
      res.redirect('/beta-private/iteration-16/start-a-claim/no-match-found');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/claim-date');
    }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/claim-date', function (req, res) {
    ...
    if (req.session.data['change'] == true ) {
      ...
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/'); // Goes back to summary
    }
    else {
      // Regular journey
      req.session.data['change'] = null;
      res.redirect('/beta-private/iteration-16/start-a-claim/baby-due-date'); // Goes to next screen in the journey
    }
  
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/baby-due-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/baby-born');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/baby-born', function (req, res) {
    ...
    if (req.session.data['baby-born'] == 'yes') {
      res.redirect('/beta-private/iteration-16/start-a-claim/baby-birth-date');
    }
    else {
      ...
      if (req.session.data['change'] == true ) {
        req.session.data['change'] = null;
        // No change
        res.redirect('/beta-private/iteration-16/start-a-claim/summary/'); // Goes back to unchanged summary
      }
      else {
        req.session.data['change'] = null;
        res.redirect('/beta-private/iteration-16/start-a-claim/employment/');
      }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/baby-birth-date', function (req, res) {
    if (req.session.data['change'] == true ) {
      req.session.data['change'] = null;
      ...
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/change-baby-birth-date'); // NEEDS TO BE CHANGED TO CHANGED SUMMARY
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/employment/');
    }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/employment/', function (req, res) {
    if (req.session.data['employment-type'] == 'agency') {
      res.redirect('/beta-private/iteration-16/start-a-claim/employment/agency-employment-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/');
    }
  });
  
  // router.post('/beta-private/iteration-16/start-a-claim/employment/test-period-agency', function (req, res) {
  ...
  router.post('/beta-private/iteration-16/start-a-claim/employment/agency-employment-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/employment/agency-employed');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/employment/agency-employed', function (req, res) {
    if (req.session.data['agency-employed'] == 'no') {
      res.redirect('/beta-private/iteration-16/start-a-claim/employment/agency-employment-end-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work');
    }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/employment/agency-employment-end-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/chosen-map-date');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/', function (req, res) {
    if (req.session.data['stopped-work'] == 'yes') {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/reason');
    }
    else {
  ...
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/reason', function (req, res) {
    if (req.session.data['stopped-work-reason'] == 'sick') {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/allowance-type');
    } else {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/date-last-worked');
    }
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/allowance-type', function (req, res) {
    if (req.session.data['allowance-type'] == 'employment-and-support-allowance') {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/benefit-start-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/pregnancy-related');    
    }
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/pregnancy-related', function (req, res) {
    if (req.session.data['allowance-type'] == 'statutory-sick-pay') {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/benefit-end-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/date-last-worked');    
    }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/benefit-end-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/date-last-worked');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/sickness/benefit-start-date', function (req, res) {
      res.redirect('/beta-private/iteration-16/start-a-claim/stopped-work/date-last-worked');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/stopped-work/date-last-worked', function (req, res) {
      res.redirect('/beta-private/iteration-16/start-a-claim/chosen-map-date');
  });
  
  // Removed maternity leave question
  // router.post('/beta-private/iteration-16/start-a-claim/ma-start-date-provided', function (req, res) {
  //  if (req.session.data['ma-start-date-provided'] == 'yes') {
  //    res.redirect('/beta-private/iteration-16/start-a-claim/planned-dlw-date');
  //  }
  //  else {
  //    res.redirect('/beta-private/iteration-16/start-a-claim/chosen-map-date');
  //  }
  ...
  router.post('/beta-private/iteration-16/start-a-claim/planned-dlw-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/chosen-map-date');
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/chosen-map-date', function (req, res) {
    if (req.session.data['ma-date-requested'] == 'yes') {
      res.redirect('/beta-private/iteration-16/start-a-claim/requested-start-date');
    }
    else {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/');
    }
  });
  
  router.post('/beta-private/iteration-16/start-a-claim/requested-start-date', function (req, res) {
    res.redirect('/beta-private/iteration-16/start-a-claim/summary/');
  });
  
  router.get('/beta-private/iteration-16/start-a-claim/summary/', function (req, res) {
    if (req.session.data['scenario'] == 'scenario-1') {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/1');
    } else if (req.session.data['scenario'] == 'scenario-2') {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/2');
    } else {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/3');
    }
  });
  
  // *** Find a claim *** //
  
  router.post('/beta-private/iteration-16/find-a-claim/', function (req, res) {
    res.redirect('/beta-private/iteration-16/find-a-claim/summary');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/select-claim', function (req, res) {
      res.redirect('/beta-private/iteration-16/find-a-claim/summary/');
  });
  
  router.get('/beta-private/iteration-16/find-a-claim/summary/', function (req, res) {
    if (req.session.data['scenario'] == 'scenario-1') {
      res.redirect('/beta-private/iteration-16/find-a-claim/summary/1');
    } else if (req.session.data['scenario'] == 'scenario-2') {
      res.redirect('/beta-private/iteration-16/start-a-claim/summary/2');
    } else {
      res.redirect('/beta-private/iteration-16/find-a-claim/summary/3');
    }
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/rti/change', function (req, res) {
  ...
  router.post('/beta-private/iteration-16/find-a-claim/employers/change-employer-1', function (req, res) {
    req.session.data['ma-employer-1'] = 'CHANGE EMP 1 LTD';
    res.redirect('/beta-private/iteration-16/find-a-claim/summary/');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/employers/change-employer-2', function (req, res) {
    req.session.data['ma-employer-2'] = 'CHANGE EMP 2 LTD';
    res.redirect('/beta-private/iteration-16/find-a-claim/summary/');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/employers/change-employer-3', function (req, res) {
    req.session.data['ma-employer-3'] = 'CHANGE EMP 3 LTD';
    res.redirect('/beta-private/iteration-16/find-a-claim/summary/1-three-employers');
  });
  
  // Payslip
  // Payslip find claim
  
  router.post('/beta-private/iteration-16/find-a-claim/employers/add-employer', function (req, res) {
    ...
    res.redirect('/beta-private/iteration-16/find-a-claim/payslip/frequency');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/payslip/frequency', function (req, res) {
    res.redirect('/beta-private/iteration-16/find-a-claim/payslip/add');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/payslip/add', function (req, res) {
    res.redirect('/beta-private/iteration-16/find-a-claim/payslip/summary');
  });
  
  router.post('/beta-private/iteration-16/find-a-claim/payslip/summary', function (req, res) {
    if (req.session.data['ma-payslip-details-conf'] == 'yes') {
      res.redirect('/beta-private/iteration-16/find-a-claim/payslip/add');
    } else {
      res.redirect('/beta-private/iteration-16/find-a-claim/summary/1-three-employers');
  ...
  router.post('/beta-private/iteration-16/find-a-claim/employers/remove-employer-3', function (req, res) {
  ...
  router.post('/beta-private/iteration-16/start-a-claim/summary/2', function (req, res) {
    res.redirect('/beta-private/iteration-16/payments/');
  });
  
  router.post('/beta-private/iteration-16/payments/', function (req, res) {
    res.redirect('/beta-private/iteration-16/payments/payment-frequency');
  });
  
  router.post('/beta-private/iteration-16/payments/payment-frequency', function (req, res) {
    ...
    res.redirect('/beta-private/iteration-16/payments/summary');
  });
  
  router.post('/beta-private/iteration-16/payments/summary', function (req, res) {
    if (req.session.data['ma-payment-details-conf'] == 'yes') {
      res.redirect('/beta-private/iteration-16/payments/somewhere');
    } else {
      res.redirect('/beta-private/iteration-16/payments/prepopulated-account-details');
    }
  });
  
  router.post('/beta-private/iteration-16/payments/prepopulated-account-details', function (req, res) {
    res.redirect('/beta-private/iteration-16/payments/prepopulated-payment-frequency');
  });
  
  router.post('/beta-private/iteration-16/payments/prepopulated-payment-frequency', function (req, res) {
    if (req.session.data['payment-frequency'] == '2-weeks') {
      req.session.data['payment-frequency'] = 'Every 2 weeks';
    } else {
      req.session.data['payment-frequency'] = 'Every 4 weeks';
  ...
  router.post('/beta-private/iteration-16/start-a-claim/summary/2-rti-changed', function (req, res) {
    res.redirect('/beta-private/iteration-16/payments');
  });
